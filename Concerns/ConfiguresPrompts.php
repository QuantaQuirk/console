...
trait ConfiguresPrompts
{
    ...
    protected function configurePrompts(InputInterface $input)
    {
        ...
        Prompt::interactive(($input->isInteractive() && defined('STDIN') && stream_isatty(STDIN)) || $this->quantaquirk->runningUnitTests());

        Prompt::fallbackWhen(windows_os() || $this->quantaquirk->runningUnitTests());
