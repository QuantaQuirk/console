...
use QuantaQuirk\Cache\DynamoDbStore;
use QuantaQuirk\Contracts\Cache\Factory as Cache;
...
class CacheCommandMutex implements CommandMutex
{
     ...
     *
     * @param  \QuantaQuirk\Console\Command  $command
     * @return bool
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Cache\Store  $store
     * @return bool
     */
