...
class Schedule
{
     ...
     *
     * @var \QuantaQuirk\Console\Scheduling\EventMutex
     */
     ...
     *
     * @var \QuantaQuirk\Console\Scheduling\SchedulingMutex
     */
    ...
    public function __construct($timezone = null)
    {
        ...
        if (! class_exists(Container::class)) {
            throw new RuntimeException(
                'A container implementation is required to use the scheduler. Please install the quantaquirk/container package.'
            );
        }
     ...
     * @return \QuantaQuirk\Console\Scheduling\CallbackEvent
     */
     ...
     * @param  array  $parameters
     * @return \QuantaQuirk\Console\Scheduling\Event
     */
     ...
     *
     * @return \QuantaQuirk\Contracts\Bus\Dispatcher
     *
     * @throws \RuntimeException
     */
    protected function getDispatcher()
    {
        if ($this->dispatcher === null) {
            try {
                ...
                throw new RuntimeException(
                    'Unable to resolve the dispatcher from the service container. Please bind it or install the quantaquirk/bus package.',
