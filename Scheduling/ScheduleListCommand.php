...
class ScheduleListCommand extends Command
{
     ...
     */
    private function sortEvents(\QuantaQuirk\Support\Collection $events, DateTimeZone $timezone)
    {
     ...
     *
     * @param  \QuantaQuirk\Console\Scheduling\CallbackEvent  $event
     * @return string
     */
    private function getClosureLocation(CallbackEvent $event)
    {
        ...
        if ($callback instanceof Closure) {
            ...
            return sprintf(
                '%s:%s',
                str_replace($this->quantaquirk->basePath().DIRECTORY_SEPARATOR, '', $function->getFileName() ?: ''),
